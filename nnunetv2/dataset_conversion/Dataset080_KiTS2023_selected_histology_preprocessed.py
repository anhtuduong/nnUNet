...
def convert_kits2023(kits_base_dir: str, nnunet_dataset_id: int = 220):
    task_name = "KiTS2023_selected_histology_preprocessed"
    ...
    generate_dataset_json(out_base, {0: "CT"},
                          ...
                          regions_class_order=(1, 3, 2, 4, 5, 6, 7, 8),
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', required=False, type=int, default=80, help='nnU-Net with histology preprocessed dataset ID, default: 080')
